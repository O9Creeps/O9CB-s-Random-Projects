...
jade = ["Winter", "Moon", "Kinkajou", "Turtle", "Carnelian", "Qibli", "Umber"]
gold = ["Icicle", "Sora", "Bigtail", "Tamarin", "Onyx", "Pike", "Flame"]
silver = ["Changbai", "Sepia", "Fearless", "Boto", "Ostrich", "Anemone", "Thrush"]
copper = ["Alba", "Marsh", "Mindreader", "Coconut", "Pronghorn", "Snail", "Peregrine"]
quartz = ["Ermine", "Newt", "Mightyclaws", "Siamang", "Arid", "Barracuda", "Garnet"]

# i dont think the ai understands winglets very well
